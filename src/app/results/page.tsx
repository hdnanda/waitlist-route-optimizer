                  ...
                  >
                    <div className="rounded-b-xl bg-[#050505] border-x border-b border-[#E8A33D]/30 px-4 pb-5 pt-3 text-xs text-slate-300 leading-5 space-y-3">
                      {[
                        ...
                        ["REAL PLAN", "The brains behind RailPravesh is a custom in-house routing & NLP engine that runs 100% locally with zero external API calls at runtime. It pairs deterministic PRS graph reasoning — discovering open intermediate quotas on the same train and nearby alternates — with a conversational parser that handles speech, self-corrections, transliterations, and multi-city intent on the fly."],
